...
class TestConversationalFlexibility:
    ...
    def test_information_request_during_qualification_should_return_to_qualification(
        self,
    ):
    ...
    def test_proposed_intelligent_information_node(self):
        ...
        test_scenarios = [
            ...
            },
            {
                ...
                "state": {"parent_name": "João", "qualification_attempts": 4},
    ...
    def test_conversational_flow_integration_simulation(self):
        ...
        with patch("app.core.langgraph_flow.get_openai_client") as mock_openai:
            with patch("app.core.langgraph_flow.send_text") as mock_send:
                ...
                assert (
                    post_info_routing == "qualification_node"
                ...
                assert (
                    final_routing == "scheduling_node"
                ), "Complete qualification should go to scheduling"

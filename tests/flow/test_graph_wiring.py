...
class TestGraphWiring:
    ...
    async def test_graph_calls_the_correct_qualification_node_implementation(self):
        ...
        with patch('app.core.nodes.qualification.qualification_node') as mock_correct_node, \
             patch('app.core.langgraph_flow.qualification_node', mock_correct_node):
            ...
            try:
                ...
                print("🔍 DIAGNOSIS: Graph is calling inline qualification_node, not the refactored version")
    ...
    async def test_inline_qualification_node_should_not_exist_after_fix(self):
        ...
        module_functions = [name for name, obj in inspect.getmembers(langgraph_flow) 
        ...
        inline_functions_that_should_not_exist = [
            ...
            if func == 'qualification_node'
        ]
        
        assert len(inline_functions_that_should_not_exist) == 0, \
            f"Found inline qualification_node functions that should have been removed: {inline_functions_that_should_not_exist}"
            
        print("✅ VERIFICATION: No inline qualification_node found - clean architecture!")
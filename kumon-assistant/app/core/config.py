...
class Settings(BaseSettings):
    ...
    EMBEDDING_MODEL_NAME: str = (
        "sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2"  # Primary model
    )
    ...
    def validate_openai_api_key(cls, v, values):
        ...
        if env in [Environment.PRODUCTION, Environment.STAGING] and values.get(
    ...
    def get_critical_missing_vars(self) -> List[str]:
        ...
        if self.is_production_like():
            ...
            if (
                ...
                or self.DATABASE_URL == "postgresql://user:password@localhost/kumon_db"
            ):

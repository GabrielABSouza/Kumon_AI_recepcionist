...
class ServiceFactory:
    ...
    async def _create_service(self, name: str) -> Any:
        ...
        try:
            ...
            if config['dependencies'] and any('llm_service' in dep for dep in config['dependencies']):
...
def register_core_services():
    ...
    service_factory.register_service(
        ...
        initialization_args={'llm_service_instance': None},  # Will be replaced with actual dependency
        async_init=False
    )

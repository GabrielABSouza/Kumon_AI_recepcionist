...
from .production_llm_service import production_llm_service
...
class LangGraphLLMAdapter:
    ...
    def __init__(self, 
        ...
        app_logger.info("LangGraph LLM Adapter initialized", extra={
            "model": model,
    ...
    async def ainvoke(self, messages: List[BaseMessage], **kwargs) -> AIMessage:
        ...
        system_prompt, user_message, conversation_history = self._extract_system_and_user_messages(converted_messages)
...
class KumonLLMService:
    ...
    def __init__(self):
        ...
        self.business_context = {
            ...
            "phone": "(51) 99692-1999",
            "pricing": {
                "per_subject": "R$ 375,00",
                "enrollment_fee": "R$ 100,00"
            },
            "hours": {
                "weekdays": "9h às 12h e 14h às 17h",
                "weekend": "Fechado"
            },
...
# Global instances
langgraph_llm_adapter = LangGraphLLMAdapter()
kumon_llm_service = KumonLLMService()


# Convenience function to replace ChatOpenAI in existing code
def create_kumon_llm(model: str = "gpt-4-turbo", temperature: float = 0.3, **kwargs) -> LangGraphLLMAdapter:
    """
    Create Kumon-optimized LLM adapter
    Drop-in replacement for ChatOpenAI with enhanced functionality
    """
    return LangGraphLLMAdapter(model=model, temperature=temperature, **kwargs)
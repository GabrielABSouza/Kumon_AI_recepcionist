        ...
        for service_name in critical_services:
            try:
                ...
                critical_services_status[service_name] = {
                    "resolvable": True,
                    "resolution_source": unified_service_resolver.resolution_history.get(
        ...
        response_data = {
            ...
            "performance_summary": {
                ...
                "cache_hit_rate": round(
                    (
                        metrics["resolution_sources"]["cache_hits"]
            ...
            "system_integration": {
                "service_factory_available": len(
                    resolver_health["available_services"]["service_factory"]
                )
                > 0,
                "optimized_startup_available": len(
                    resolver_health["available_services"]["optimized_startup"]
                )
                > 0,
                "dual_system_operational": (
                    len(resolver_health["available_services"]["service_factory"]) > 0
                    and len(resolver_health["available_services"]["optimized_startup"]) > 0
                ),
            },
        }

...
class AdvancedIntentClassifier:
    ...
    async def classify_intent(
        ...
        try:
            ...
            final_result = self._integrate_context(
                llm_enhanced_result, context, conversation_state
            )
            ...
            app_logger.info(f"Intent classified: {final_result.category.value} "
    ...
    async def _enhance_with_llm(
        ...
        try:
            ...
            classification_prompt = ChatPromptTemplate.from_messages([
                ("system", """Você é um classificador de intenções para o Kumon Assistant.

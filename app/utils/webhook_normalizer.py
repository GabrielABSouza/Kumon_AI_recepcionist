...
def normalize_webhook_payload(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    valid_intents = {
        "greeting", "information_request", "qualification", 
        "scheduling", "fallback", "objection"
    }
    ...
    if not isinstance(response_text, str) or not response_text.strip():
        out["response_text"] = "Desculpe, tive um probleminha ao responder. Pode repetir, por favor?"
